...
(function (API) {
    ...
    var options = {
        ...
        renderFooter: function(options) {
            ...
            doc.text(ch, options.margins.horizontal, size.height - options.margins.bottom);
            var txt = 'Sida 4 av 1';
            var width = size.width - options.margins.horizontal - getStringWidth(txt);
            doc.text(txt, width, size.height - options.margins.bottom);
        },
